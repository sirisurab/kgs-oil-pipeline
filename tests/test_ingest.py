...
class TestDiscoverRawFiles:
    ...
    @pytest.mark.unit
    def test_discover_raw_files_finds_txt_files(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_discover_raw_files_sorted(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_discover_raw_files_empty_dir(self, tmp_path):
...
class TestReadRawFiles:
    ...
    @pytest.mark.unit
    def test_read_raw_files_basic(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_read_raw_files_has_source_file_column(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_read_raw_files_lowercase_columns(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_read_raw_files_empty_list_raises(self):
        """Given empty file_paths list, assert ValueError is raised."""
        with pytest.raises(ValueError):
            read_raw_files([])

    @pytest.mark.unit
    def test_read_raw_files_returns_dask_not_pandas(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_read_raw_files_skips_corrupt_file(self, tmp_path, caplog):
...
class TestParseMonthYear:
    ...
    @pytest.mark.unit
    def test_parse_month_year_filters_yearly_and_cumulative(self):
    ...
    @pytest.mark.unit
    def test_parse_month_year_dtype_is_datetime(self):
    ...
    @pytest.mark.unit
    def test_parse_month_year_parsing_examples(self):
    ...
    @pytest.mark.unit
    def test_parse_month_year_invalid_value_produces_nat(self):
    ...
    @pytest.mark.unit
    def test_parse_month_year_returns_dask_dataframe(self):
...
class TestExplodeApiNumbers:
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_basic(self):
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_single_api(self):
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_null_api(self):
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_returns_dask_dataframe(self):
        """Assert return type is dask.dataframe.DataFrame."""
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_column_renamed(self):
    ...
    @pytest.mark.unit
    def test_explode_api_numbers_missing_column_raises(self):
...
class TestWriteInterimParquet:
    ...
    @pytest.mark.unit
    def test_write_interim_parquet_returns_path(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_write_interim_parquet_creates_output_dir(self, tmp_path):
    ...
    @pytest.mark.integration
    def test_write_interim_parquet_readable(self, tmp_path):
    ...
    @pytest.mark.integration
    def test_write_interim_parquet_preserves_rows(self, tmp_path):
...
class TestRunIngestPipeline:
    ...
    @pytest.mark.unit
    def test_run_ingest_pipeline_calls_functions_in_order(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_run_ingest_pipeline_empty_files_returns_none(self, tmp_path):
    ...
    @pytest.mark.unit
    def test_run_ingest_pipeline_no_compute_on_intermediates(self, tmp_path):
    ...
    @pytest.mark.integration
    def test_run_ingest_pipeline_real_raw_dir(self):
